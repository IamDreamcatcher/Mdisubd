--functions compare
CREATE OR REPLACE PROCEDURE CREATING_FUNCTIONS(dev_schema_name VARCHAR2, prod_schema_name VARCHAR2)
    AUTHID CURRENT_USER
    IS
    counter NUMBER(10);
BEGIN
...
CREATE OR REPLACE PROCEDURE DELETING_FUNCTIONS(dev_schema_name VARCHAR2, prod_schema_name VARCHAR2)
    AUTHID CURRENT_USER
    IS
BEGIN
...
CREATE OR REPLACE PROCEDURE UPDATING_FUNCTIONS(dev_schema_name VARCHAR2, prod_schema_name VARCHAR2)
    AUTHID CURRENT_USER
    IS
    counter NUMBER(10);
BEGIN
